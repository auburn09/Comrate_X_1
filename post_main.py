...
# Выборка строк с непустым id и пустым epgu_code
...
logging.info(f"Найдено строк с непустым id и пустым epgu_code: {unmatched_count}")
...
try:
    unmatched_with_id.to_csv(unmatched_file, sep=';', index=False, encoding='utf-8')
